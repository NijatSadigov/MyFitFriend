package com.example.myfitfriend.domain.use_case.helpers
...
class IsOwnedDietGroupUseCase @Inject constructor(
    private val repository:MyFitFriendRepository
){
    operator fun invoke(groupId: Int):Flow<Resources<Int>> =flow{
