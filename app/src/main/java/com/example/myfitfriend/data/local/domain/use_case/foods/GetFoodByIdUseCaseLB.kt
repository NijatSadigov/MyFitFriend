...
class GetFoodByIdUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(foodId:Int):Flow<Resources<LocalFoodEntity>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.getFoodById(foodId)
