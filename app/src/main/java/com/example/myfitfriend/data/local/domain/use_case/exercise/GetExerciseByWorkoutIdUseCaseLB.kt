...
class GetExerciseByWorkoutIdUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(exerciseId:Int):Flow<Resources<List<ExerciseEntity>>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.getExercisesByWorkoutId(exerciseId)
