...
class DeleteDietaryLogByIdUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(dietaryLogId:Int):Flow<Resources<Int>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.removeLog(dietaryLogId)
