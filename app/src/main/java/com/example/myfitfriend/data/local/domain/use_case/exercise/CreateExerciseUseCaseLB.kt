...
class CreateExerciseUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(ee:ExerciseEntity):Flow<Resources<Long>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.createExercise(ee)
