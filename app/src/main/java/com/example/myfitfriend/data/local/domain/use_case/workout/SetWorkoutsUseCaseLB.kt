...
class SetWorkoutsUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(workouts: List<WorkoutEntity>):Flow<Resources<List<Long>>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.setAllWorkouts(workouts)
