...
class SetDietaryLogsUseCaseLB @Inject constructor(
    private val repository: MyFitFriendLocalRepository
){
operator fun invoke(logs: List<DietaryLogEntity>):Flow<Resources<List<Long>>> =flow{

try {
        emit(Resources.Loading())

       val response= repository.setDietaryLogs(logs)
